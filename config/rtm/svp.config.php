...
$widgets = [
    ...
    ['id' => 'svpApiProdCpuUsage' . $stageAll['id'],'type' => 'graph','params' => ['span' => 6,'dao' => 'newRelic','metric' => 'cpuUsage','appId' => $stageAll['id'],'subtitle' => 'CPU USAGE','title' => $stageAll['label'], 'valueSuffix' => '%','beginDateTime' => '-30 minutes','endDateTime' => 'now',],],
