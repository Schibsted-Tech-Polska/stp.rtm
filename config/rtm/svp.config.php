...
$widgets = [
    ...
    ['id' => 'VGTV_v2_api_develop','type' => 'build','params' => ['span' => 1,'dao' => 'jenkins','view' => 'svp-api','job' => 'svp-api-develop','metric' => 'status','title' => 'SVP API DEVELOP',],],
    ['id' => 'VGTV_v2_smoke_tests','type' => 'build','params' => ['span' => 1,'dao' => 'jenkins','view' => 'VGTV_v2','job' => 'svp-api-smoke-tests-STAGING','metric' => 'status','title' => 'SVP SMOKE STAGE',],],
    ['id' => 'SVP_v2_smoke_tests','type' => 'build','params' => ['span' => 1,'dao' => 'jenkins','view' => 'SVP_v2','job' => 'svp-api-smoke-tests-PRODUCTION','metric' => 'status','title' => 'SVP SMOKE PROD',],],
    ['id' => 'vgtv2apiProductionBuild','type' => 'build','params' => ['span' => 1,'dao' => 'jenkins','view' => 'VGTV_v2','job' => 'VGTV_v2_api_production','metric' => 'status','title' => 'API PRODUCTION',],],
