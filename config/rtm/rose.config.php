    ...
    'widgets' => array(
        ...
        array(
            ...
            'params' => array(
                ...
                'title' => 'RabbitMQ',
                'span' => 2,
                'ignoreQueues' => ['.*testing.*', '.*:invalid:.*', '.*:not-existing:.*', 'aliveness-test', 'email:send', 'geo-targeting*', 'placement:*', 'rose:*', 'availability', 'ims:*'],
        ...
        array(
            ...
            'params' => array(
                ...
                'title' => 'RabbitMQ',
                'span' => 2,
                'ignoreQueues' => ['.*testing.*', '.*:invalid:.*', '.*:not-existing:.*', 'aliveness-test', 'email:send', 'campaign:*', 'customer:*', 'sync:*', 'booking:inventory'],
                'queueNameParser' => function($queueName) { return str_replace([':management', 'rose:'], '', $queueName);},
            ),
        ),
